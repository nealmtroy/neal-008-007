...
-- Tombol Muncak
local muncakBtn = createStyledButton(tpTab, "Muncak", UDim2.new(0, 180, 0, 65), UDim2.new(0, 70, 0, 25))
-- Tombol Stop
local stopBtn = createStyledButton(tpTab, "Stop", UDim2.new(0, 250, 0, 65), UDim2.new(0, 70, 0, 25))
